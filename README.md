...
**Ultima build (v0.0.5 - fix mascara de valor + versao no rodape):**

> https://github.com/nosrevelc/sos-os-mobile/releases/download/v0.0.5-test/app-debug.apk

(Outras versoes: [v0.0.4-test](https://github.com/nosrevelc/sos-os-mobile/releases/download/v0.0.4-test/app-debug.apk) | [v0.0.3-test](https://github.com/nosrevelc/sos-os-mobile/releases/download/v0.0.3-test/app-debug.apk) | [v0.0.2-test](https://github.com/nosrevelc/sos-os-mobile/releases/download/v0.0.2-test/app-debug.apk) | [v0.0.1-test](https://github.com/nosrevelc/sos-os-mobile/releases/download/v0.0.1-test/app-debug.apk))

Toque no link acima no navegador do celular para baixar o APK direto (~18 MB).

### Instalacao

1. Toque no link do APK
2. Permita instalacao de "fontes desconhecidas" (configurar uma vez, apenas para o navegador)
3. Aguarde o download
4. Toque em "Instalar"
5. Abra o app e valide o tema (claro/escuro) e os fluxos principais
...
5. Ampliar testes automatizados para o WorkOrderDriveController e UI Compose (controllers Form/Print/Message/Attachment, repos, conversao, backup, mensagens, estoque, CSV e formatadores ja cobertos).
