...
class SettingsRepository(
    ...
    companion object {
        ...
        const val TEMPLATE_PAYMENT_PENDING_KEY = "template_payment_pending"
        const val TEMPLATE_PAYMENT_CONFIRMED_KEY = "template_payment_confirmed"
        const val TEMPLATE_PAYMENT_PROOF_REQUEST_KEY = "template_payment_proof_request"
        const val TEMPLATE_ORDER_SENT_KEY = "template_order_sent"
        const val TEMPLATE_OUT_FOR_DELIVERY_KEY = "template_out_for_delivery"
        const val TEMPLATE_DELIVERED_KEY = "template_delivered"
        const val TEMPLATE_NOT_DELIVERED_KEY = "template_not_delivered"
        const val TEMPLATE_THANK_YOU_KEY = "template_thank_you"
        const val TEMPLATE_ANNOUNCEMENT_KEY = "template_announcement"
